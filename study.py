...
Usage:
    $ python path/to/study.py --weights yolov5s.pt --data coco128.yaml --img 640

Usage - formats:
    $ python path/to/study.py --weights yolov5s.pt                 # PyTorch
...
from utils.pruning_utils import plot_flops_params, model_info_modules
...
def run(
    ...
    if not training:
        ...
        params, flops = plot_flops_params(model, imgsz)
        LOGGER.info('Params: {:.2f}M GFLOPs: {:.2f}'.format(params, flops))
...
def parse_opt():
    ...
    parser.add_argument('--project', default='runs/study', help='save to project/name')
    parser.add_argument('--name', default='prun', help='save to project/name')
